...
use BreachAware\LaravelCdn\Contracts\AssetInterface;
use BreachAware\LaravelCdn\Contracts\CdnHelperInterface;
use BreachAware\LaravelCdn\Contracts\CdnInterface;
use BreachAware\LaravelCdn\Contracts\FinderInterface;
...
class Cdn implements CdnInterface
{
     ...
     *
     * @internal param \BreachAware\LaravelCdn\Repository $configurations
     */
    ...
    /**
     * Will be called from the BreachAware\LaravelCdn\PushCommand class on Fire().
     */
    ...
    /**
     * Will be called from the BreachAware\LaravelCdn\EmptyCommand class on Fire().
     */
