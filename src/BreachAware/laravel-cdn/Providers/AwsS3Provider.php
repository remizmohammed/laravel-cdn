...
namespace BreachAware\LaravelCdn\Providers;
...
use BreachAware\LaravelCdn\Providers\Contracts\ProviderInterface;
...
class AwsS3Provider extends Provider implements ProviderInterface
{
    ...
    /**
     * @var \BreachAware\LaravelCdn\Validators\Contracts\ConfigurationsInterface
     */
    protected $configurations;

    /**
     * @var \BreachAware\LaravelCdn\Validators\Contracts\ProviderValidatorInterface
     */
    protected $provider_validator;

    /**
     * @param \Symfony\Component\Console\Output\ConsoleOutput $console
     * @param \BreachAware\LaravelCdn\Validators\Contracts\ProviderValidatorInterface $provider_validator
     * @param \BreachAware\LaravelCdn\Contracts\CdnHelperInterface                    $cdn_helper
     */
