...
use BreachAware\LaravelCdn\Contracts\CdnFacadeInterface;
use BreachAware\LaravelCdn\Contracts\CdnHelperInterface;
use BreachAware\LaravelCdn\Contracts\ProviderFactoryInterface;
use BreachAware\LaravelCdn\Exceptions\EmptyPathException;
use BreachAware\LaravelCdn\Validators\CdnFacadeValidator;
...
class CdnFacade implements CdnFacadeInterface
{
    ...
    /**
     * @var \BreachAware\LaravelCdn\Contracts\ProviderFactoryInterface
     */
     ...
     *
     * @var \BreachAware\LaravelCdn\Providers\Contracts\ProviderInterface
     */
    protected $provider;

    /**
     * @var \BreachAware\LaravelCdn\Contracts\CdnHelperInterface
     */
    protected $helper;

    /**
     * @var \BreachAware\LaravelCdn\Validators\CdnFacadeValidator
     */
     ...
     *
     * @param \BreachAware\LaravelCdn\Contracts\ProviderFactoryInterface $provider_factory
     * @param \BreachAware\LaravelCdn\Contracts\CdnHelperInterface       $helper
     * @param \BreachAware\LaravelCdn\Validators\CdnFacadeValidator      $cdn_facade_validator
     */
    ...
    private function generateUrl($path, $prepend = '')
    {
        ...
        if (isset($this->configurations['enabled']) && !$this->configurations['enabled']) {
            return $path;
        }
