...
class ProviderFactoryTest extends TestCase
{
    public function setUp()
    {
        ...
        $this->provider_factory = new \BreachAware\LaravelCdn\ProviderFactory();
    }
    ...
    public function testCreateReturnCorrectProviderObject()
    {
        ...
        $m_aws_s3 = M::mock('BreachAware\LaravelCdn\Providers\AwsS3Provider');
    ...
    /**
     * @expectedException \BreachAware\LaravelCdn\Exceptions\MissingConfigurationException
     */
