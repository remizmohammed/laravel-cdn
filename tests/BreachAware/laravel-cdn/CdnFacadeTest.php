...
class CdnFacadeTest extends TestCase
{
    public function setUp()
    {
        ...
        $this->provider = M::mock('BreachAware\LaravelCdn\Providers\AwsS3Provider');

        $this->provider_factory = M::mock('BreachAware\LaravelCdn\Contracts\ProviderFactoryInterface');
        $this->provider_factory->shouldReceive('create')->once()->andReturn($this->provider);

        $this->helper = M::mock('BreachAware\LaravelCdn\Contracts\CdnHelperInterface');
        ...
        $this->validator = new \BreachAware\LaravelCdn\Validators\CdnFacadeValidator();

        $this->facade = new \BreachAware\LaravelCdn\CdnFacade(
    ...
    /**
     * @expectedException \BreachAware\LaravelCdn\Exceptions\EmptyPathException
     */
